...
sub find_utf8_turkic_locales (;$) {
    ...
    # Return the name of all thelocales that core Perl thinks are UTF-8 Turkic
    # LC_CTYPE.  Optional parameter is a reference to a list of locales to
    # try; if omitted, this tries all locales it can find on the platform
