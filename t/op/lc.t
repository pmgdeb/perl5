...
SKIP: {
    skip "Can't find a turkic UTF-8 locale", 9 unless defined $turkic_locale;

    # EBCDIC
    # These are designed to stress the calculation of space needed for the
    # strings
    my $filler_length = 1000000;
    my $filler = "\x{df}\x{b5}\x{e0}\x{c1}\x{b6}\x{ff}" x $filler_length;
    my $filler_lc = "\x{df}\x{b5}\x{e0}\x{e1}\x{b6}\x{ff}" x $filler_length;
    my $filler_fc = "ss\x{b5}\x{e0}\x{e1}\x{b6}\x{ff}" x $filler_length;
    my $filler_uc = "SS\x{39c}\x{c0}\x{c1}\x{b6}\x{178}" x $filler_length;
    use locale;
    setlocale(LC_CTYPE, $turkic_locale);

    is (lc "I\x{307}$filler", "i$filler_lc",
        "lc in Turkic locale with DOT ABOVE immediately following I");
    is (lc "I\x{307}IIIIII$filler", "i\x{131}\x{131}\x{131}\x{131}\x{131}\x{131}$filler_lc",
        "lc in Turkic locale with DOT ABOVE immediately following I, then"
      . " other I's ");
    is (lc "I\x{316}\x{307}$filler", "i\x{316}$filler_lc",
        "lc in Turkic locale with DOT ABOVE after non-ABOVE");
    is (lc "I\x{307}\x{300}$filler", "i\x{300}$filler_lc",
        "lc in Turkic locale with DOT ABOVE followed by ABOVE");
    is (lc "I\x{300}\x{307}$filler", "\x{131}\x{300}\x{307}$filler_lc",
    ...
    is (lcfirst "I\x{300}\x{307}IIIIII$filler",
    "\x{131}\x{300}\x{307}IIIIII$filler",
        "lcfirst in Turkic locale with with other ABOVE before DOT ABOVE");
    is (lcfirst "I\x{307}IIIIII$filler", "iIIIIII$filler",
        "lcfirst in Turkic locale with ");
    is (lcfirst "I\x{316}\x{307}$filler", "i\x{316}$filler",
        "lcfirst in Turkic locale with ");
    is (lcfirst "I\x{316}\x{307}IIIIII$filler", "i\x{316}IIIIII$filler",
        "lcfirst in Turkic locale with ");
    is (lcfirst "I\x{316}\x{307}\x{335}IIIIII$filler", "i\x{316}\x{335}IIIIII$filler",
        "lcfirst in Turkic locale with ");
    is (uc "i$filler", "\x{130}$filler_uc",
        "uc in XXX Turkic locale with with other ABOVE before DOT ABOVE");
}
